...
const statementsDisplay = (svgRef, svgConf) => {
  ...
  const nodes = svg.append('g')
    ...
    .attr('stroke-dashoffset', d => 2*Math.PI*10 * (1 + d.veracity / 100))
  ...
  return {
    selectNodeDraw(node: StatementType){
      ...
      .attr('stroke-dashoffset', d => (1 + d.veracity / 100) * 2*Math.PI * (d.id == node.id ? svgConf.selectedNodeRadius : svgConf.nodeRadius ))
    }
  }
